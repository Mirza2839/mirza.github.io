...
jQuery(document).ready(function() {
	...
	*/
	...
	$('a.btn-customized-dark, a.btn-customized-light').on('click', function(e) {
		e.preventDefault();
		// Toggle class 'light' pada body
		$('body').toggleClass('light');
		// Toggle class 'light' pada sidebar
...
$(document).ready(function() {
    $('#tombol').on('click', function(e) {
        e.preventDefault();
        var gambar = $('#tombol img');
        // Memeriksa apakah gambar saat ini adalah gambar1.jpg
        if (gambar.attr('src') === 'moon.png') {
            // Jika ya, ganti gambar menjadi gambar2.jpg
            gambar.attr('src', 'sun.png');
        } else {
            // Jika tidak, kembalikan ke gambar1.jpg
            gambar.attr('src', 'moon.png');
        }
    });
});
